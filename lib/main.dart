...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // The titleSection is a container containing the title row
    Widget titleSection = Container(
      padding: const EdgeInsets.all(32),
      //32 pixels padding on all sides
      //A Row is a widget used to display child widgets in a horizontal manner. The Row widget does not scroll.
      child: Row(
        children: [
          //Expanded widget stretches across the column to use all remaining free space in the row
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
